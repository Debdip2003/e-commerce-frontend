...
const OurPolicies = () => {
  return (
    <div className='py-20'>
      ...
      <div>
        <img src={exchangeIcon} alt='exchange_icon' className='w-12 m-auto mb-5'/>
        <p className='font-semibold'>Easy Excahnge Policy</p>
        <p className='text-gray-400'>We offer hassle free exchange policies</p>
      </div>
      <div>
        <img src={qualityIcon} alt='quality_icon' className='w-12 m-auto mb-5'/>
        <p className='font-semibold'>7 Days Return Pollicy</p>
        <p className='text-gray-400'>We provide 7 days free return policy</p>
      </div>
      <div>
        <img src={supportImg} alt='support_icon' className='w-12 m-auto mb-5'/>
